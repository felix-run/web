      ...
      {writeDiff ? (
        <div className="mt-3 grid gap-2 md:grid-cols-2">
          <div>
            ...
            <pre className="max-h-36 overflow-auto rounded-lg border border-border/50 bg-background p-2 font-mono text-xs text-muted-foreground">
        ...
        <pre className="mt-3 max-h-28 overflow-auto rounded-lg border border-border/50 bg-background p-2 font-mono text-xs text-muted-foreground">
