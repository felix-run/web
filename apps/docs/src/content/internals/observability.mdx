...
:::caution[Former Workers prototype]
This page describes counters and audit events from the former TypeScript Cloudflare Workers harness. The live harness is Python in [felix-run/felix](https://github.com/felix-run/felix). Prefer that repo for current metrics and audit surfaces.
:::
