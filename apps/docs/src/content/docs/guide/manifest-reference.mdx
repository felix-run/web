...
Felix passes the request's `threadId` as `session` so a multi-turn conversation reuses the same sandbox DO and filesystem state persists across turns. See [`examples/sandbox-worker/`](https://github.com/blakebauman/felix-run/blob/main/packages/harness/examples/sandbox-worker/) for the reference adapter.
...
See [`examples/browser-worker/`](https://github.com/blakebauman/felix-run/blob/main/packages/harness/examples/browser-worker/) for the reference adapter.
...
Absolute ceilings ([src/limits/models.ts](https://github.com/blakebauman/felix-run/blob/main/packages/harness/src/limits/models.ts)):
