...
- The wire contract is hand-mirrored from the Python harness in packages/felix-protocol; the proxy Worker and the vite dev proxy are two copies of the same /api/* contract (api-contract-change skill).
